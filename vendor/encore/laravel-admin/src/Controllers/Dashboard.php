...
class Dashboard
{
    ...
    {
        $lists=project::select('project_name','platform','amount')->get();

        return view('project', compact('lists'));
    }


    public static function showSong()
    {
        $lists=song::select('project_name','platform','amount')->get();

        return view('project', compact('lists'));
    }


    public static function showFanClub()
    {
        $lists=project::select('project_name','platform','amount')->get();
